...
```{r fig.cap="図1: 実行時間O(n^3) x:0~100", echo=FALSE}
x <- 0:110
plot(x, (x^3)*0.0000012, type = 'l', lwd = 1, xlab="matrix size(n)", ylab="execution time")
...
text(60, 0.8, labels = "y = 0.0000012 * x^3")

```
図1: 行列サイズ(n=0~100)に対する実行時間O(n^3)


```{r fig.cap="図2: 実行時間O(n^3) x:0~1000", echo=FALSE}
x <- 0:1100
plot(x, (x^3)*0.0000012, type = 'l', lwd = 1, xlab="matrix size(n)", ylab="execution time")
...
points(50, 0.149971)
points(100, 1.219841)
points(500, 150.851577)
points(1000, 1283.936824)

text(600, 800, labels = "y = 0.0000012 * x^3")
